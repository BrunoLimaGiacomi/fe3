...
- Antes de mudanças grandes, explique plano e risco de rollback.
- Subagentes usam o mesmo modelo MaaS resolvido para esta sessão e os mesmos limites de segurança.
- Subagentes têm mutação habilitada por padrão. Defina allow_mutation=false quando a tarefa for estritamente de leitura e não precisar de CLI ou PowerShell.
...
def agent_loop(
    ...
    print_labeled("AgenteGlobal CLI", style="cyan")
